 ...
 *
 * Contributors:
 *     IBM - Initial API and implementation (copied from org.eclipse.core.tests.harness package)
 *******************************************************************************/
...
public class TestBarrier {
	...
	/**
	 * Blocks the calling thread until the status integer at the given index is
	 * set to the given value. Fails if the status change does not occur in a
	 * reasonable amount of time.
	 * 
	 * @param statuses
	 *            the array of statuses that represent the states of an array of
	 *            jobs or threads
	 * @param index
	 *            the index into the statuses array that the calling thread is
	 *            waiting for
	 * @param status
	 *            the status that the calling thread should wait for
	 */
	...
	/**
	 * Creates a new test barrier suitable for a single thread, with the given
	 * initial status.
	 */
